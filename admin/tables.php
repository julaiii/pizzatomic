...
// Check connection
    ...
    $newdescpizza = $_POST['descpizza'];
    $sql = 'UPDATE reglages SET descpizza = "'.$newdescpizza.'"';
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title">Modifier le descriptif Pizza!</h3>

                            </div>
                            <form method='post' action='tables.php'>
                    
                     <textarea name="descpizza" id="descpizza" rows="10" cols="80"><?php echo $descpizza ; ?></textarea>
            <script>
                CKEDITOR.replace( 'descpizza' );
            </script>
